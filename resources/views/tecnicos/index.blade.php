...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Técnicos</h1>
</div>
<div class="mb-4">
    <a href="{{ route('tecnicos.create') }}">
        <button type="button" class="btn btn-primary">Añadir nuevo técnico</button>
    </a>
</div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="{{ route('tecnicos.edit', $tecnico->id) }}" class="btn-editar btn-sm">
                                        <i class="fas fa-edit"></i> Editar
                                    </a>
                                    <button type="button" class="btn-eliminar btn-sm" onclick="confirmDelete({{ $tecnico->id }})">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                ¿Seguro que quieres eliminar este técnico?
            </div>
