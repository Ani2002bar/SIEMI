...
<div class="container-fluid px-4">
    ...
    <div class="detail-container">
        ...
        <div class="detail-info">
            ...
            <img src="{{ $equipo->imagen ? asset($equipo->imagen) : asset('img/6QQGqDyu_400x400.jpg') }}" alt="Imagen del Equipo" class="detail-image">
        ...
        <div class="detail-info">
            ...
            <div class="detail-item">
                <label>Local:</label>
                <p>{{ $equipo->locale->nombre_local ?? 'Sin asignar' }}</p>
            </div>
            <div class="detail-item">
